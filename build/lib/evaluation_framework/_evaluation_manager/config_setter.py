...
class ConfigSetter():
    ...
    def __init__(self,  estimator=None, 
                 ...
                 user_configs=dict(), local_directory_path=None, S3_path=None):
    ...
    def set_configs(self, *, estimator=None,
        ...
        # have a method to check and rmtree etc...
...
#                     print(k, 3)
    ...
    def _validate_local_directory_path(self):
        ...
        # os.makedirs(self.memmap_root_dirpath)
